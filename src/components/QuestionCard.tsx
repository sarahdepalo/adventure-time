...
const QuestionCard: React.FC<Props> = ({question, answer1, answer1CharacterValues, answer2, answer2CharacterValues, answer3, answer3CharacterValues, answer4, answer4CharacterValues, addValues}) => {
    return (
